...
param = setparameters_bending_local();
...
load 'bent_plate_img_bottom_100.mat';
load 'plate_img_100.mat';

Img_source = plate_img;
Img_target = bent_plate_img;
...
vtkwrite('post_processing/source_bending.vtk', 'structured_grid',Xvtk,Yvtk,Zvtk,'scalars','Intensity',Img_source);
vtkwrite('post_processing/target_bending.vtk', 'structured_grid',Xvtk,Yvtk,Zvtk,'scalars','Intensity',Img_target);
...
for multilev = 0:1:param.maxlevel-1
    ...
    filename = sprintf('post_processing/Bending_mesh_%d.vtk',multilev+1);
    ...
    while (iterct_level < itermax)
        ...
        save('post_processing/bending_residuals.mat','iter_reg','iter_img','iterations');
        if(mod(iterct_level,500)==0)
            ...
            filename_vtk = sprintf('post_processing/evolve_bending_local_%d.vtk',iterct);
    ...
    filename_vtk1 = sprintf('post_processing/bending_deformed_%d.vtk',multilev+1);
