...
%F_prestrain = [0.83, 0, 0; 0,0.83,0; 0,0,0.83];
%% 1: Read image data
...
for multilev = 0:1:param.maxlevel-1
    ...
    while (iterct_level < itermax)
        ...
        [RHS, RHS_image, RHS_reg, LRHS_reg, RHS_total, final_error] = compute_Integ_Domain_hyper_elastic_prestrain_mex(Jm,img_error,Bterm1,Bterm2,Bterm3,BIGXX,BIGYY,BIGZZ,BIGMUX,BIGMUY,BIGMUZ,BIGMVX,BIGMVY,BIGMVZ,BIGMWX,BIGMWY,BIGMWZ,RHS,PHI1,PHIU1,PHIV1,PHIW1,param.mu, param.lambda, param.alpha, param.beta,Wu,Wv,Ww,H,cII_SX,F_prestrain);
