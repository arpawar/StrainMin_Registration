    ...
    for multilev = 0:1:param.maxlevel-1
        ...
        while (iterct_level < itermax)
            ...
            if(mod(iterct_level,itermax)==0)
                ...
                vtkwrite(filename_vtk, 'structured_grid',pyy,pxx,pzz,'scalars','StrainEnergy',strain_energy,'scalars','J',Jdet,'scalars','F11',F11,'scalars','F22',F22,'scalars','F33',F33,'scalars','thetag',theta_g,'scalars','thetae',theta_e);
            end
            ...
            if(mod(iterct_level,itermax)==0)
                ...
                subplot(3,2,3)
                plot(nstep_vec,total_theta_center);
                subplot(3,2,4)
                plot(nstep_vec,theta_g_center);
                subplot(3,2,5)
                plot(nstep_vec,theta_e_center);
                %             subplot(4,2,6)
