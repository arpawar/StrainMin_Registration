function [pxx, pyy, pzz,F11, F22, Jdet, strain_energy] = tripleIterLoop(sizeImage, Pixel, Jm, ACP, Img_target,param)
...
for i = 1:sizeImage(1,3)
    ...
    [temp_pxx, temp_pyy, temp_pzz ,temp_F11, temp_F22, temp_Jdet, temp_strain_energy] = tripleIterLoopBody(i, sizeImage, Pixel, Jm, ACP, Img_target(:,:,i),param);
...
function [ pxx, pyy, pzz,F11, F22, Jdet, strain_energy] = tripleIterLoopBody(i, sizeImage, Pixel, Jm, ACP, Img_target,param)
