...
param = setparameters_biaxial_local();
...
for i =1:Nx
    for j=1:Ny
        for k=1:Nz
            if(i>=15 && i<=35 && j>=15 && j<=35 && k>=20 && k<=30)
...
vtkwrite('post_processing/source_biaxial.vtk', 'structured_grid',Xvtk,Yvtk,Zvtk,'scalars','Intensity',Img_source);
vtkwrite('post_processing/target_biaxial.vtk', 'structured_grid',Xvtk,Yvtk,Zvtk,'scalars','Intensity',Img_target);
