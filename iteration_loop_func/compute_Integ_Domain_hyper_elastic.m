function [RHS_final,RHS_image, RHS_reg, LRHS_reg, RHS_total, final_error] = compute_Integ_Domain_hyper_elastic(Jm,img_error,Bterm1,Bterm2,Bterm3,BIGXX, BIGYY, BIGZZ, BIGMUX,BIGMUY,BIGMUZ,BIGMVX,BIGMVY,BIGMVZ,BIGMWX,BIGMWY,BIGMWZ,RHS,PHI1,PHIU1,PHIV1,PHIW1,mu, lambda, alpha, beta,w1,w2,w3,H,Img_source)
%#codegen
    ...
    for gg1 = 1:xlen
        for gg2 = 1:xlen
            for gg3 = 1:xlen
                ...
                Fg_inv = eye(3,3);
                F = single(eye(3,3));
                F(1,:) = [g11(gg1,gg2,gg3), g21(gg1,gg2,gg3), g31(gg1,gg2,gg3)]; 
                F(2,:) = [g12(gg1,gg2,gg3), g22(gg1,gg2,gg3), g32(gg1,gg2,gg3)]; 
                F(3,:) = [g13(gg1,gg2,gg3), g23(gg1,gg2,gg3), g33(gg1,gg2,gg3)];
                Fe = F*Fg_inv;
                ...
                error = error + w1(gg1,1).*w2(gg2,1).*w3(gg3,1)*term_img(gg1,gg2,gg3);
                ...
                for j = 1:size(phi_ui,1)
                    ...
                    val1(j,1) = val1(j,1) + alpha*(phi_i(j,1)).*w1(gg1,1).*w2(gg2,1).*w3(gg3,1).*(term1(gg1,gg2,gg3)).*hu.*hv.*hw + 2.*beta.*w1(gg1,1).*w2(gg2,1).*w3(gg3,1).*img_source1(gg1,gg2,gg3).*sum_finalx.*hu.*hv.*hw;
                    val2(j,1) = val2(j,1) + alpha*(phi_i(j,1)).*w1(gg1,1).*w2(gg2,1).*w3(gg3,1).*(term2(gg1,gg2,gg3)).*hu.*hv.*hw + 2.*beta.*w1(gg1,1).*w2(gg2,1).*w3(gg3,1).*img_source1(gg1,gg2,gg3).*sum_finaly.*hu.*hv.*hw;
                    val3(j,1) = val3(j,1) + alpha*(phi_i(j,1)).*w1(gg1,1).*w2(gg2,1).*w3(gg3,1).*(term3(gg1,gg2,gg3)).*hu.*hv.*hw + 2.*beta.*w1(gg1,1).*w2(gg2,1).*w3(gg3,1).*img_source1(gg1,gg2,gg3).*sum_finalz.*hu.*hv.*hw;
                    
                    val11(j,1) = val11(j,1) + alpha*(phi_i(j,1)).*w1(gg1,1).*w2(gg2,1).*w3(gg3,1).*(term1(gg1,gg2,gg3)).*hu.*hv.*hw;
                    val22(j,1) = val22(j,1) + alpha*(phi_i(j,1)).*w1(gg1,1).*w2(gg2,1).*w3(gg3,1).*(term2(gg1,gg2,gg3)).*hu.*hv.*hw;
                    val33(j,1) = val33(j,1) + alpha*(phi_i(j,1)).*w1(gg1,1).*w2(gg2,1).*w3(gg3,1).*(term3(gg1,gg2,gg3)).*hu.*hv.*hw;
