function [RHS_final,RHS_image, RHS_reg, LRHS_reg, RHS_total] = compute_Integ_Domain_hyper_elastic_1(Jm,Bterm1,Bterm2,Bterm3,BIGXX, BIGYY, BIGZZ, BIGMUX,BIGMUY,BIGMUZ,BIGMVX,BIGMVY,BIGMVZ,BIGMWX,BIGMWY,BIGMWZ,RHS,PHI1,PHIU1,PHIV1,PHIW1,param,w1,w2,w3,H,Img_source)
%#codegen
