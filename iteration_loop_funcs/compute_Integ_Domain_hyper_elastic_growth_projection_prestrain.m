function [RHS_final,RHS_image, RHS_reg, LRHS_reg, RHS_total, final_error, theta_g_new_final,Mass_matrix_final, RHS_theta_final] = compute_Integ_Domain_hyper_elastic_growth_projection_prestrain(Jm,img_error,Bterm1,Bterm2,Bterm3,BIGXX, BIGYY, BIGZZ, BIGMUX,BIGMUY,BIGMUZ,BIGMVX,BIGMVY,BIGMVZ,BIGMWX,BIGMWY,BIGMWZ,RHS,PHI1,PHIU1,PHIV1,PHIW1,mu, lambda, alpha, beta,beta_1, w1,w2,w3,H,Img_source, kappa, dtime,theta_g_old,F_prestrain)
%#codegen
    ...
    for gg1 = 1:xlen
        for gg2 = 1:xlen
            for gg3 = 1:xlen
                ...
                if(img_source1(gg1,gg2,gg3)>0.9)
                    Fp = F_prestrain;
                    Fg = theta_g_o*eye(3,3);
                    Fg_star = Fg*Fp;
